...
-- If the table already exists in production, run this once in phpMyAdmin:
-- ALTER TABLE contact_registrations ADD COLUMN selected_package VARCHAR(100) AFTER waiver_accepted;
